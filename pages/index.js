    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
            ...
            <p><b>O "jogo do bicho" é uma loteria baseada em 25 animais do zoológico do Barão Drummond</b>. Cada animal tem um número e é atribuído a 4 dezenas. As apostas são feitas em combinações entre esses animais, seus números, dezenas e/ou milhares relacionados a eles.</p>
